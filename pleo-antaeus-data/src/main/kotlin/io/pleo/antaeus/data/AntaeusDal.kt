...
class AntaeusDal(private val db: Database) {
    ...
    fun updateInvoice(invoice: Invoice): Invoice? {
        return updateInvoice(invoice.id, invoice.amount, invoice.customerId, invoice.status)
    }

    fun updateInvoice(id: Int, amount: Money, customerId: Int, status: InvoiceStatus = InvoiceStatus.PENDING): Invoice? {
        transaction(db) {
            // Insert the invoice and returns its new id.
            InvoiceTable
